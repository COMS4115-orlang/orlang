...
%token PLUS MINUS TIMES DIV MOD FPLUS FMINUS FDIV FTIMES FMOD
...
%token TRUE FALSE 
%token PRINT ORD CHR FPTOSI SITOFP
...
%left PRINT ORD CHR FPTOSI SITOFP
%left LIST
...
| expr FMOD   expr            { NoHint(Binop(FMOD, $1, $3)) }
