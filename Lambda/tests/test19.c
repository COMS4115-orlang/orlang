...
void* b_call(void* genenv, void* fun){
...
define i8* @d_init(i8* %g, i8* %fun) {
entry:
  %g1 = alloca i8*, align 8
  store i8* %g, i8** %g1, align 8
  %fun2 = alloca i8*, align 8
  store i8* %fun, i8** %fun2, align 8
  ...
  store i8* %argval, i8** %elem_ptr, align 8
  %argval5 = load i8*, i8** %fun2, align 8
...
define i8* @c_init(i8* %fun) {
entry:
  %fun1 = alloca i8*, align 8
  store i8* %fun, i8** %fun1, align 8
  ...
  %argval = load i8*, i8** %fun1, align 8
